...
var _dec, _class, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class2, _class3;
let Player = (_dec = NearBindgen({}), _dec(_class = class Player {
  constructor(account, opportunities) {
    this.account = account;
    this.opportunities = opportunities;
  }
}) || _class);
let LotteryContract = (_dec2 = NearBindgen({}), _dec3 = call({
  payableFunction: true
}), _dec4 = call({
  payableFunction: true
}), _dec5 = call({}), _dec6 = view(), _dec7 = view(), _dec8 = view(), _dec2(_class2 = (_class3 = class LotteryContract {
  players = new UnorderedMap('l');
  lucky_number = 0;
  ...
  set_lucky_number({
    ...
    assert(signerAccountId() == "tepic.testnet", "No tienes permisos para ejecutar este comando.");
  ...
  buy_tickets() {
    ...
    const account = signerAccountId.toString();
    const deposito = attachedDeposit();
    log("payment: " + deposito + " price: " + ONE_NEAR);
    ...
    if (player) {
      ...
      const {
        opportunities
      } = this.players.get(account);
      log("player exists and has " + opportunities + " opportunities");
    } else {
  ...
  play({
    ...
    if (player) {
      ...
      if (this.lucky_number == playNumber) {
        ...
        log("Sorry you lost, try again. Good luck!");
      }
...
}, (_applyDecoratedDescriptor(_class3.prototype, "set_lucky_number", [_dec3], Object.getOwnPropertyDescriptor(_class3.prototype, "set_lucky_number"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "buy_tickets", [_dec4], Object.getOwnPropertyDescriptor(_class3.prototype, "buy_tickets"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "play", [_dec5], Object.getOwnPropertyDescriptor(_class3.prototype, "play"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "get_opportunities", [_dec6], Object.getOwnPropertyDescriptor(_class3.prototype, "get_opportunities"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "get_ticket_price", [_dec7], Object.getOwnPropertyDescriptor(_class3.prototype, "get_ticket_price"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "get_number", [_dec8], Object.getOwnPropertyDescriptor(_class3.prototype, "get_number"), _class3.prototype)), _class3)) || _class2);
function get_number() {
  const _state = LotteryContract._getState();
  if (!_state && LotteryContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = LotteryContract._create();
  if (_state) {
    LotteryContract._reconstruct(_contract, _state);
  }
  const _args = LotteryContract._getArgs();
  const _result = _contract.get_number(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LotteryContract._serialize(_result, true));
}
function get_ticket_price() {
  ...
  const _args = LotteryContract._getArgs();
  const _result = _contract.get_ticket_price(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LotteryContract._serialize(_result, true));
}
function get_opportunities() {
  ...
  const _args = LotteryContract._getArgs();
  const _result = _contract.get_opportunities(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LotteryContract._serialize(_result, true));
}
function play() {
  const _state = LotteryContract._getState();
  ...
  const _args = LotteryContract._getArgs();
  const _result = _contract.play(_args);
  LotteryContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LotteryContract._serialize(_result, true));
}
function buy_tickets() {
  ...
  const _args = LotteryContract._getArgs();
  const _result = _contract.buy_tickets(_args);
  LotteryContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LotteryContract._serialize(_result, true));
}
function set_lucky_number() {
  const _state = LotteryContract._getState();
  if (!_state && LotteryContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = LotteryContract._getArgs();
  const _result = _contract.set_lucky_number(_args);
  LotteryContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(LotteryContract._serialize(_result, true));
}

export { buy_tickets, get_number, get_opportunities, get_ticket_price, play, set_lucky_number };
